# Dynamic Search Suggestion Algorithm Sample

This project was generated with [Angular CLI](https://github.com/angular/angular-cli) version 1.0.3.

# Add your COSMOS API Keys
Find the file 'COSMOS-Accelerators-AutoSuggest / src / app / services / cognitive-api.service.ts' and add your own COSMOS API keys. 
...
6. Success!  You should see a working demo of the Dynamic Search Suggestion Algorithm built on Angular.
